...
| **Link auf GitHub:**     | https://github.com/EUF-SpoWis/M1_Einfuehrung_Sportwissenschaft/blob/main/01_Grundlagen.md       |
| **Autoren:**             | @author                                                                                         |
...
| Modell                      | Beschreibung                                                                 |
|-----------------------------|------------------------------------------------------------------------------|
| Wettkampfmodell             | Meisterschaften und Ligen ohne Profitum (mit kodifizierten Regeln)          |
| Professioneller Showsport   | Meisterschaften im Profitum, sportiver Tourismus & Showsport                |
| Expressives Modell          | Abenteuer- und Erlebnissport, Fun-Sport, Sport ohne traditionellen Leistungsvergleich |
| Funktionalistisches Modell  | Gesundheitssport, Fitnesssport, Bodybuilding, Schulsport                    |
| Traditionelle Spielkulturen | Wiederbelebung traditioneller Spiele: z. B. Bosseln                         |

„Sport ist körperliche Bewegung, Sport unterliegt dem Leistungsprinzip, Sport ist durch soziale Normen geregelt, Sport ist unproduktiv!“ (Heinemann, 1980, 32).

**Strukturprägende Varialben nach Heinemann (1980)**

| Modell / Kernelement         | Bewegung, körperl. Einsatz  | Unproduktivität  | Regeln            | Leistungsbezogen | Willkürlich geschaffene Handlung |
|------------------------------|-----------------------------|------------------|------------------|------------------|-----------------------------------|
| Wettkampfmodell              | gegeben                     | gegeben          | gegeben          | gegeben          | bedingt gegeben                   |
| Professioneller Showsport    | gegeben                     | nicht gegeben    | gegeben          | gegeben          | bedingt gegeben                   |
| Expressives Modell           | gegeben                     | gegeben          | bedingt gegeben  | bedingt gegeben  | gegeben                           |
| Funktionales Modell          | gegeben                     | nicht gegeben    | nicht gegeben    | nicht gegeben    | nicht gegeben                     |
| Traditionelle Spielkulturen  | gegeben                     | gegeben          | bedingt gegeben  | bedingt gegeben  | bedingt gegeben                   |


## Fragebogen: Sportmotivation

**Ich treibe Sport oder ich würde Sport treiben, weil ich …**

| Pol A                             | Pol B                                   |
|-----------------------------------|-----------------------------------------|
| mit anderen zusammen sein will    | mich gesund und fit halten will         |
| mich selbst überwinden will       | mich entspannen will                    |
| Aufregung und Nervenkitzel brauche| Freude an schönen Bewegungen habe       |
| mich gesund und fit halten will   | mich entspannen will                    |
| Freude an schönen Bewegungen habe | mit anderen zusammen sein will          |
| mich gesund und fit halten will   | mich selbst überwinden will             |
| mich entspannen will              | Aufregung und Nervenkitzel brauche      |
| mich selbst überwinden will       | mit anderen zusammen sein will          |
| mich gesund und fit halten will   | Freude an schönen Bewegungen habe       |
| Aufregung und Nervenkitzel brauche| mich selbst überwinden will             |
| mich entspannen will              | mit anderen zusammen sein will          |
| mich selbst überwinden will       | Freude an schönen Bewegungen habe       |
| Aufregung und Nervenkitzel brauche| mich gesund und fit halten will         |
| Freude an schönen Bewegungen habe | mich entspannen will                    |
| mit anderen zusammen sein will    | Aufregung und Nervenkitzel brauche      |

## Sportwissenschaft

** Definition von Sportwissenschaft **

> Sportwissenschaft zielt darauf ab, mit Hilfe wissenschaftlicher Methoden „die differenzierten Phänomene von Sport, Bewegung und körperlicher Aktivität wahrzunehmen, zu beschreiben, zu analysieren und zu erklären sowie Orientierungen und Entscheidungshilfen für die Verbesserung der vielfältigen Praxis zu entwickeln." [(Hottenrott et al, 2017, S. 288)](https://link.springer.com/article/10.1007/s12662-017-0476-x)
...
<details>
<summary>Arbeitsauftrag</summary>
...
- Abb. Johann Christoph Friedrich Guts Muths (1759–1839), Lithographie, gemeinfrei (Public Domain). Quelle: Wikimedia Commons, Datei „J‑C‑F‑GutsMuths.jpg“, URL: https://commons.wikimedia.org/wiki/File:J-C-F-GutsMuths.jpg (abgerufen am [Datum]).
- Abb. Friedrich-Ludwig-Jahn: Friedrich-Ludwig-Jahn-Museum; Licence: CC BY-NC-SA (https://creativecommons.org/licenses/by-nc-sa/4.0/)
